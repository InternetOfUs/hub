...
class Nationality {
    ...
    const STATE_CZECH_REPUBLICH = "czech_republic";
    const STATE_DENMARK = "denmark";
    const STATE_ENGLAND = "england";
    const STATE_ESTONIA = "estonia";
    ...
    const STATE_LATVIA = "latvia";
    const STATE_LITHUANIA = "lithuania";
    const STATE_LUXEMBOURG = "luxembourg";
    ...
    const STATE_REPUBLIC_OF_CYPRUS = "Κύπριοι";
    ...
    public static function nationalityLabels() {
        return [
            ...
            self::STATE_CZECH_REPUBLICH => "čeština",
            self::STATE_DENMARK => "Dansk",
            self::STATE_ENGLAND => "English",
            self::STATE_ESTONIA => "Eestlane",
            ...
            self::STATE_LATVIA => "Latvietis",
            self::STATE_LITHUANIA => "Lietuvis",
            self::STATE_LUXEMBOURG => "Lëtzebuergesch",
            ...
            self::STATE_REPUBLIC_OF_CYPRUS => "Κύπριοι",
